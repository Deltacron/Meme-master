...
export class MemStorage implements IStorage {
  ...
  private async initializeCards() {
    ...
    const captionCards = [
      ...
      "When Netflix asks 'Are you still watching?' like it doesn't know the answer.",
      "When you say 'five more minutes' and wake up three hours later.",
      "When the group chat makes plans without you.",
      "When your mom says 'We need to talk.'",
      "When the WiFi drops right in the middle of your show.",
      "When you accidentally like a 2012 photo while stalking someone's Instagram.",
      "When the waiter says 'Enjoy your meal' and you say 'You too.'",
      "When you check your bank account after a night out.",
      "When you text 'I'll be there in 5 minutes' but haven't even left home.",
      "When your crush leaves you on read.",
      "When you remember something embarrassing you did 5 years ago.",
      "When your boss says 'We're like family here.'",
      "When you realize you're the 'funny friend,' not the 'hot friend.'",
      "When the Uber driver talks the whole ride.",
      "When your Spotify shuffle plays nothing but sad songs.",
      "When I realize my phone battery dies faster than my dreams.",
      "When I wave back at someone who wasn't waving at me.",
      "When someone says 'trust me' and I immediately don't.",
      "When the vending machine actually works and I feel alive.",
      "When I hear footsteps behind me but live alone.",
      "When you clap at the end of a movie… why though?",
      "When I eat healthy for one day and expect abs.",
      "When someone says 'we need to talk' and I start planning my funeral.",
      "When I sneeze in public and feel like Patient Zero.",
      "When I hit 'Reply All' and instantly regret it.",
      "When you finally stand up and your knees sound like bubble wrap.",
      "When I laugh at my own joke and no one else does.",
      "When someone tells me to 'just relax' like that ever works.",
      "When I start a diet and end up eating cake at 2 AM.",
      "When you try to flirt and sound like a customer service bot.",
      "When I Google my symptoms and it says I'm already dead.",
      "When someone says 'smile more' and I smile less.",
      "When I give relationship advice but remain forever single.",
      "When you accidentally open your front camera and see a cryptid.",
      "When I realize adulthood is just Googling how to do things.",
      "When you press snooze 7 times and still complain you're tired.",
      "When I try to act natural but forget how to walk.",
      "When someone asks if I'm okay and I say 'I'm fine'… biggest lie ever.",
      "When I hear a noise at 3 AM and just accept death.",
      "When you wave at someone and they don't wave back.",
      "When I remember something cringe I did 10 years ago.",
      "When you finish a series and have to face your own life again.",
      "When I text 'LOL' but I'm actually crying inside.",
      "When someone chews too loud and I start planning a crime.",
      "When I trip over nothing and blame gravity personally.",
      "When someone says 'trust the process' and I immediately don't.",
      "When I sneeze while driving and almost meet God.",
      "When you spend $200 online to avoid a $10 delivery fee.",
      "When I drop food on the floor and consider the 5-year rule.",
      "When I lie in bed thinking about every mistake I've ever made.",
      "When you accidentally like a 5-year-old post at 3 AM.",
      "When I open TikTok for 5 minutes and lose 5 hours.",
      "When someone says 'it could be worse' and somehow it gets worse.",
      "When I say 'I'll save money this month' and Amazon laughs.",
      "When you sneeze too loud and the neighbors know your secrets.",
      "When I lose a staring contest with a baby.",
      "When someone starts a sentence with 'no offense'… it's always offensive.",
      "When I clean my room and immediately lose something important.",
      "When you clap when the plane lands… why though?",
      "When I remember that one embarrassing text I sent in 2012.",
      "When you finish a snack and feel abandoned by it.",
      "When I hear kids outside and close the blinds immediately.",
      "When someone says 'good vibes only' and I bring bad vibes.",
      "When I see a cop and act like I committed 3,000 crimes.",
      "When someone says 'be yourself' but I don't like myself.",
      "When I get lost in my own neighborhood like a tourist.",
      "When you say 'brb' but disappear forever.",
      "When I realize my search history could put me in prison.",
      "When you tell a story and forget the ending halfway.",
      "When I sneeze and pull a muscle I didn't know existed.",
      "When you realize the vegetables you bought are just future trash.",
      "When I go to bed early but scroll until 4 AM.",
      "When someone says 'it's just a game' but I've already lost my soul.",
      "When I close my laptop dramatically to feel powerful.",
      "When you join a Zoom call and regret your career instantly.",
      "When I see my reflection in a store window and regret existing.",
      "When someone says 'let's hang out' but I hope they cancel.",
      "When I spend 30 minutes cooking and eat it in 3.",
      "When you sneeze in public and everyone looks at you like a criminal.",
      "When I drop my phone and the charger saves it like divine intervention.",
      "When someone says 'you look tired'… thanks, I know.",
      "When I start exercising and immediately need a snack.",
      "When someone sends 'haha' but they're dead inside too.",
      "When I finish cleaning and instantly make a new mess.",
      "When someone says 'just breathe'… revolutionary advice.",
      "When I turn on my camera and see the crypt keeper.",
      "When someone says 'congrats' but it's just LinkedIn.",
      "When I run into someone I ghosted and pretend I'm blind.",
      "When you walk into a spider web and perform a horror ballet.",
      "When I think about exercising and need a nap instead.",
      "When someone says 'live, laugh, love' and I want to do none.",
      "When I hit shuffle and it plays the one song I hate.",
      "When you clap at the end of a Zoom call… please don't.",
      "When I text 'haha' but meant 'crying into the void.'",
      "When someone says 'don't be so negative' and I stay negative.",
      "When I wake up from a nap and don't know my own name.",
      "When you wave at a stranger and they ignore you.",
      "When I hear my alarm and negotiate with Satan.",
      "When someone says 'you'll find someone' and I don't believe it.",
      "When I open the fridge and realize it's just sadness inside.",
      "When someone says 'calm down' and I get angrier.",
      "When I try to be productive but end up scrolling memes.",
      "When someone says 'everything happens for a reason'… sure Jan.",
      "When I watch true crime like it's a self-help guide.",
      "When you laugh at something you shouldn't and make it worse.",
      "When I read side effects and suddenly feel all of them.",
      "When someone says 'it's not that deep' but I'm drowning.",
      "When I see a clown and feel personally attacked.",
      "When you sneeze and the dog looks at you in judgment.",
      "When I buy new clothes but wear the same hoodie anyway.",
      "When someone says 'smile more' and I smile less.",
      "When I think about responsibilities and need another nap.",
      "When someone says 'you've changed'… good.",
      "When I spend hours making a to-do list and lose it instantly.",
      "When the teacher uses your answer as the wrong example.",
      "When someone claps after the plane lands.",
      "When your parents find your secret stash of snacks.",
      "When you run into your ex looking like a potato.",
      "When you order salad but secretly want fries.",
      "When someone says 'Let's circle back to that.'",
      "When you try to act normal after sending a risky text.",
      "When you sneeze in public and everyone looks at you like you started a pandemic.",
      "When you pretend to be asleep so you don't have to help.",
      "When your stomach growls louder than your voice in class.",
      "When you thought the Zoom call ended but it didn't.",
      "When you see your reflection after a night of drinking.",
      "When your friend says 'This will only take 5 minutes.'",
      "When you thought you hit 'Reply' but actually hit 'Reply All.'",
